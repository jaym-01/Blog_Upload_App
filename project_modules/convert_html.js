...
var fr = require('fs');
function convertHTML(req, res, save_path) {
    var options = {
        convertImage: mammoth.images.imgElement(function (image) {
            return image.readAsBuffer().then(function (imageBuffer) {
                ...
                var d = new Date();
                var img_path = save_path.substring(1, save_path.length) + "/" + d.getDate() + d.getMonth() + d.getFullYear() + d.getHours() + d.getMinutes() + d.getSeconds() + d.getMilliseconds() + ".jpg";
